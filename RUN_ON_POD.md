...
```sh
cd /tmp
curl -L -O https://github.com/ortega-io/opensleep-diagnostic/releases/download/diagnostic-v15/opensleep-diagnostic-aarch64-static
curl -L -O https://github.com/ortega-io/opensleep-diagnostic/releases/download/diagnostic-v15/opensleep-diagnostic-aarch64-static.sha256
